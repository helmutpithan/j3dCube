 ...
 */
public class Rot_M_invY extends Rot
{ static J3dFrame myJ3dFrame;
	Button rotAchse_M_invY;
  static boolean f; 
  static Set<Integer> setB=new HashSet<Integer>();
  
    Button getrotAchse_M_invY()
    { return rotAchse_M_invY;
      }
      
    static public void M_invY_Action()
    {        
                                      ...
                                      {                                      	  
                                       ...
                                       case 9://Drehachse
                                          ...
                                          switch(id)
                                         {
                                          ...
                                          //System.out.println("c24p15i9->c24p25i41");
                                          break;                                                                                    
     ...
     */
    public Rot_M_invY(J3dFrame myJ3dFrame,int xa,int ya, int b,int h)
    { this.myJ3dFrame=myJ3dFrame;
        rotAchse_M_invY=new Button("n"); // rotAchseUp-->
            rotAchse_M_invY.setBounds(xa,ya,b,h);
            
         rotAchse_M_invY.addActionListener(new ActionListener()
