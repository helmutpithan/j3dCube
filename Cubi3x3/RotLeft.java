...
public class RotLeft extends Rot
  ...
  static Set<Integer> setL=new HashSet<Integer>();
    ...
    {       if(myJ3dFrame.showCubi0) setL.add(0);
          ...
          if(finish())
                                 ...
                                 { 
                                      ...
                                      switch(place) 
                                      {
                                         ...
                                         //System.out.println("c2p22i46->c2p16i24"); 
                                          ...
                                          case 14:branchGroup=myJ3dFrame.cubi2.getCubi2BranchGroup(myJ3dFrame.cubi2BranchGroup,16,40,myJ3dFrame.cubi2.colors);//30
                                 ...
                                 {  
                                      ...
                                      switch(place) {
                                         ...
                                         //System.out.println("c22p22i14->c22p16i24"); 
                                          ...
                                          case 46:branchGroup=myJ3dFrame.cubi22.getCubi22BranchGroup(myJ3dFrame.cubi22BranchGroup,16,8,myJ3dFrame.cubi22.colors);
                         ...
                         case 23: //cubi23
                                 ...
                                 {    
                                      ...
                                      {                                     
                                          ...
                                          switch(id)
                                         {
                                          case 23:branchGroup=myJ3dFrame.cubi23.getCubi23BranchGroup(myJ3dFrame.cubi23BranchGroup,14,46,myJ3dFrame.cubi23.colors);
                                         ...
                                         case 14:
                                          switch(id)
                                         {
                                          case 46:branchGroup=myJ3dFrame.cubi23.getCubi23BranchGroup(myJ3dFrame.cubi23BranchGroup,23,9,myJ3dFrame.cubi23.colors);
               ...
               myJ3dFrame.Lalpha.setStartTime(System.currentTimeMillis()+100);
               myJ3dFrame.Lwinkel=myJ3dFrame.Lwinkel+((float) Math.PI/2);
               //System.out.println("front+Lwinkel "+myJ3dFrame.Lwinkel);
                f=finish();
                while(!f){ f=finish();}
               //System.out.println("Left<--");
              }
     ...
     */
    public RotLeft(J3dFrame myJ3dFrame,int xa,int ya, int b,int h)
