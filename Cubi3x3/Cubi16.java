 ...
 */
public class Cubi16 extends Cubi
...
{ //id=6, place=6,mode=0 ,LEFT:black, RIGHT:yellow, FRONT:black, BACK:red,TOP:green, BOTTOM:black     
 ...
 { //id=9, place=1, mode=0 ,LEFT:black, RIGHT:yellow, FRONT:red, BACK:black,TOP:black, BOTTOM:green
  ...
  {//id=7, place=7,mode=2, LEFT:green, RIGHT:black,FRONT:black, BACK:red ,TOP:yellow, BOTTOM:black    
    ...
    public BranchGroup getCubi16BranchGroup(BranchGroup branchGroup,int place,int id,float[][] colors) 
   { this.place=place;
    ...
    public Cubi16(BranchGroup brauchGroup,int nr,int place,int id,double paramDouble)
