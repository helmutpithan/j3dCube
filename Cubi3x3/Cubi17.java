 ...
 */
public class Cubi17 extends Cubi
{static BranchGroup branchGroup=null;
  ...
  // grün -rot-gelbe Ecke 
    /**
     * Constructor for objects of class Cubi17
     */
      static final float[][] colors = new float[][]{ 
                                                 ...
                                                 // rot durch weiß ersetzen und gelb durch rot ersetzen
                                                    {//id=0,place=0 ,mode=0,LEFT:green, RIGHT:black, FRONT:red, BACK:black,TOP:black BOTTOM:yellow  
      //0:Farben LEFT=green,FRONT=red,Bottom=yellow                                                //LEFT
 ...
 { //id=9, place=1, mode=0 ,LEFT:black, RIGHT:yellow, FRONT:red, BACK:black,TOP:black, BOTTOM:green
       ...
       {//id=10, place=2, mode=0 ,LEFT:black, RIGHT:red, FRONT:black, BACK:yellow,TOP:black, BOTTOM:green
        ...
        { //id=1, place=1,mode=2, LEFT:black, RIGHT:green, BACK:black,FRONT:yellow,TOP:black, BOTTOM:red
            ...
            { //id=2, place=2,mode=2, LEFT:black, RIGHT:yellow, BACK:green,FRONT:black,TOP:black, BOTTOM:red
                                                      //LEFT
                                                      0.0F,0.0F, 0.0F,//black
                                                      0.0F,0.0F, 0.0F,
                                                      0.0F,0.0F, 0.0F,
         ...
         { //id=3, place=3,mode=2, LEFT:green, RIGHT:black, BACK:yellow,FRONT:black,TOP:black, BOTTOM:red
                                                      //LEFT
                                                      0.0F,0.0F, 0.0F,//green
                                                      0.0F,0.0F, 0.0F,
                                                      0.0F,0.0F, 0.0F,
    ...
    { //einmal F
     //id=4, place=4,mode=2, LEFT:red, RIGHT:black,FRONT:green, BACK:black ,TOP:yellow, BOTTOM:black    
                                                      //LEFT
                                                      1.0F, 1.0F, 1.0F,//weiß
                                                      1.0F, 1.0F, 1.0F,
                                                      1.0F, 1.0F, 1.0F,
       ...
       {//id=5, place=5,mode=2, LEFT:black, RIGHT:green,FRONT:red, BACK:black ,TOP:yellow, BOTTOM:black    
                                                      //LEFT
                                                      0.0F, 0.0F, 0.0F,//black
                                                      0.0F, 0.0F, 0.0F,
                                                      0.0F, 0.0F, 0.0F,
  ...
  {//id=6, place=6,mode=2, LEFT:black, RIGHT:red,FRONT:black, BACK:green ,TOP:yellow, BOTTOM:black    
                                                      //LEFT
                                                      0.0F, 0.0F, 0.0F,//black
                                                      0.0F, 0.0F, 0.0F,
                                                      0.0F, 0.0F, 0.0F,
  ...
  {//id=7, place=7,mode=2, LEFT:green, RIGHT:black,FRONT:black, BACK:red ,TOP:yellow, BOTTOM:black    
                                                      //LEFT
                                                      0.0F,0.0F, 0.0F,//green
                                                      0.0F,0.0F, 0.0F,
                                                      0.0F,0.0F, 0.0F,
    ...
    public BranchGroup getCubi17BranchGroup(BranchGroup branchGroup,int place,int id,float[][] colors) 
   { this.place=place;
    ...
    public Cubi17(BranchGroup brauchGroup,int nr,int place,int id,double paramDouble)
