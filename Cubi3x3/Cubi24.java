 ...
 */
public class Cubi24 extends Cubi
{static BranchGroup branchGroup=null;
    // instance variables - replace the example below with your own
  // grün -rot-gelbe Ecke 
    /**
     * Constructor for objects of class Cubi24
     */
...
public BranchGroup getCubi24BranchGroup(BranchGroup branchGroup,int place,int id,float[][] colors) 
   {   this.place=place;
    ...
    public Cubi24(BranchGroup branchGroup,int nr,int place,int id,double paramDouble)
    { 
