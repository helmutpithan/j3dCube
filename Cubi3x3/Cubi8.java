 ...
 */
public class Cubi8 extends Cubi
{static BranchGroup branchGroup=null;
    // instance variables - replace the example below with your own
  // grün -rot-gelbe Ecke Top und Bottom sind immer schwarz 
    /**
     * Constructor for objects of class Cubi8
     */
   public void Ausgabe()
...
{ //id=14, place=6, mode=0 ,LEFT:black, RIGHT:green, FRONT:black, BACK:yellow,TOP:red, BOTTOM:black 
 ...
 { //id=18, place=2,mode=0, LEFT:black, RIGHT:yellow, BACK:green,FRONT:black,TOP:black, BOTTOM:red
  ...
  {//id=23, place=7,mode=0, LEFT:green, RIGHT:black,FRONT:black, BACK:red ,TOP:yellow, BOTTOM:black    
    ...
    public BranchGroup getCubi8BranchGroup(BranchGroup branchGroup,int place,int id,float[][] colors) 
   {   this.place=place;
       this.idmem=id;//<-- wegen 3x3
       id=id/2;
       this.id=id;//<--
    //Plätze sollen so nummeriert werden wie beim cubi2x2
       
    int i=0;
    int j=0;
    int k=0;
    // i,j,k nehmen 0,1,2 an 
    ...
    public Cubi8(BranchGroup branchGroup,int nr,int place,int id,double paramDouble)
    { 
