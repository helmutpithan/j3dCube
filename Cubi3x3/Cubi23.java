 ...
 */
public class Cubi23 extends Cubi
{static BranchGroup branchGroup=null;
  ...
  // grün -rot-gelbe Ecke 
     ...
     */
      static final float[][] colors = new float[][]{ //platz 0,1,2,3 einmal im Uhrzeigersinn Downebene , gelb bleibt unten
                                                 //   id 0,1,2,3
                                                 //   position 0,1,2 für die untere Ebene
                                                
                                                    {//Cubi0: id=0,place=0 ,mode=0,LEFT:green, RIGHT:black, FRONT:red, BACK:black,TOP:black BOTTOM:yellow
 //Cubi7: id=0,place=0 ,mode=0,LEFT:green, RIGHT:black, FRONT:orange, BACK:black,TOP:black BOTTOM:white  
                                                     //LEFT
...
{ //id=6, place=6,mode=0 ,LEFT:black, RIGHT:yellow, FRONT:black, BACK:red,TOP:green, BOTTOM:black     
 ...
 { //id=9, place=1, mode=0 ,LEFT:black, RIGHT:yellow, FRONT:red, BACK:black,TOP:black, BOTTOM:green
       ...
       {//id=10, place=2, mode=0 ,LEFT:black, RIGHT:red, FRONT:black, BACK:yellow,TOP:black, BOTTOM:green
          ...
          {//id=11, place=3, mode=0 ,LEFT:yellow, RIGHT:black, FRONT:black, BACK:red,TOP:black, BOTTOM:green
                       ...
                       // einmal F
     { //id=12, place=4, mode=0 ,LEFT:green, RIGHT:black, FRONT:yellow, BACK:black,TOP:red, BOTTOM:black  //Vielleicht hier        
                                                      //Left
                                                      0.0F, 0.0F, 0.0F,//orange
                                                      0.0F, 0.0F, 0.0F,
                                                      0.0F, 0.0F, 0.0F,
 ...
 { //id=19, place=3,mode=0, LEFT:green, RIGHT:black, BACK:yellow,FRONT:black,TOP:black, BOTTOM:red
    ...
    { //einmal F
     //id=20, place=4,mode=0, LEFT:green, RIGHT:black,FRONT:white, BACK:black ,TOP:orange, BOTTOM:black    
                                                      //LEFT
                                                      0.0F, 1.0F, 0.0F,//green
                                                      0.0F, 1.0F, 0.0F,
                                                      0.0F, 1.0F, 0.0F,
  ...
  {//id=7, place=7,mode=2, LEFT:green, RIGHT:black,FRONT:black, BACK:red ,TOP:yellow, BOTTOM:black    
     ...
     public BranchGroup getCubi23BranchGroup(BranchGroup branchGroup,int place,int id,float[][] colors) 
   { this.place=place;
    ...
    public Cubi23(BranchGroup brauchGroup,int nr,int place,int id,double paramDouble)
