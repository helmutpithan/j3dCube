 ...
 */
public class Cubi0 extends Cubi
...
public BranchGroup getCubi0BranchGroup(BranchGroup branchGroup,float[][] colors) 
   { 
    ...
    public BranchGroup getCubi0BranchGroup(BranchGroup branchGroup,int place,int id,float[][] colors) 
   { this.id=id;
     this.place=place;
 ...
 /*   
   ...
   { int i=0;
    ...
    final Vector3f vector = new Vector3f(x, y,z);
     ...
     tg.addChild(makeShape(id,0,colors));
   ...
   { int i=0;
    ...
    public Cubi0(BranchGroup branchGroup,int nr,int place,int id,double paramDouble)
    { 
