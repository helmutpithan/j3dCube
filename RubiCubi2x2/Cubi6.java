 ...
 */
public class Cubi6 extends Cubi
  ...
  // grün -rot-gelbe Ecke 
     ...
     */
      static final float[][] colors = new float[][]{ 
                                                 ...
                                                 //grün durch blau ersetzen rot durch weiß ersetzen gelb durch orange ersetzen
                                                 
 
{//id=0,place=0 ,mode=0,LEFT:blue, RIGHT:black, FRONT:white, BACK:black,TOP:black BOTTOM:orange 
  
      //Farben LEFT=green,FRONT=red,Bottom=yellow                                               
						      //LEFT
                                                      0.0F, 0.0F, 1.0F,//blue
                                                      0.0F, 0.0F, 1.0F,
                                                      0.0F, 0.0F, 1.0F,
...
{ //id=6, place=6,mode=0 ,LEFT:black, RIGHT:yellow, FRONT:black, BACK:red,TOP:green, BOTTOM:black     
 ...
 { //id=9, place=1, mode=0 ,LEFT:black, RIGHT:yellow, FRONT:red, BACK:black,TOP:black, BOTTOM:green
  ...
  {//id=23, place=7,mode=0, LEFT:green, RIGHT:black,FRONT:black, BACK:red ,TOP:yellow, BOTTOM:black    
   ...
   public BranchGroup getCubi6BranchGroup(BranchGroup branchGroup,float[][] colors) 
   { 
     int i=0;
     int j=0;
     int k=0;
    ...
    final Vector3f vector = new Vector3f(x, y,z);
     ...
     public BranchGroup getCubi6BranchGroup(BranchGroup branchGroup,int place,int id,float[][] colors) 
   { this.id=id;
     this.place=place;
    ...
    public Cubi6(BranchGroup brauchGroup,int nr,int place,int id,double paramDouble)
