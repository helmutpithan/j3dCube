...
{ static J3dFrame myJ3dFrame;
 Button rotAchseZ;
  ...
  {         setD.add(0);
    ...
    public RotZ(J3dFrame myJ3dFrame,int xa,int ya, int b,int h)
    {  this.myJ3dFrame=myJ3dFrame;
    	rotAchseZ=new Button("Z"); // rotAchseZ-->
            rotAchseZ.setBounds(xa,ya,b,h);
            
         rotAchseZ.addActionListener(new ActionListener()
            { 
