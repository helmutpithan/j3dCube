...
{ //id=6, place=6,mode=0 ,LEFT:black, RIGHT:yellow, FRONT:black, BACK:red,TOP:green, BOTTOM:black     
 ...
 { //id=19, place=3,mode=0, LEFT:green, RIGHT:black, BACK:yellow,FRONT:black,TOP:black, BOTTOM:red
  ...
  {//id=7, place=7,mode=2, LEFT:green, RIGHT:black,FRONT:black, BACK:red ,TOP:yellow, BOTTOM:black    
     ...
     public BranchGroup getCubi7BranchGroup(BranchGroup branchGroup,int place,int id,float[][] colors) 
   { this.id=id;
     this.place=place;
  ...
  public BranchGroup getCubi7BranchGroup(BranchGroup branchGroup,float[][] colors) 
   { 
     int i=0;
     int j=0;
     int k=0;
    ...
    public Cubi7(BranchGroup brauchGroup,int nr,int place,int id,double paramDouble)
