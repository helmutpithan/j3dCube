 ...
 */
public class Cubi3 extends Cubi
  ...
  // grün -rot-gelbe Ecke 
     ...
     */
      static final float[][] colors = new float[][]{ 
                                                 ...
                                                 // grün durch orange ersetzen , rot durch grün ersetzen
...
{ //id=6, place=6,mode=0 ,LEFT:black, RIGHT:yellow, FRONT:black, BACK:red,TOP:green, BOTTOM:black     
 ...
 { //id=9, place=1, mode=0 ,LEFT:black, RIGHT:yellow, FRONT:red, BACK:black,TOP:black, BOTTOM:green
  ...
  {//id=23, place=7,mode=0, LEFT:green, RIGHT:black,FRONT:black, BACK:red ,TOP:yellow, BOTTOM:black    
   ...
   public BranchGroup getCubi3BranchGroup(BranchGroup branchGroup,float[][] colors) 
   { 
     int i=0;
     int j=0;
     int k=0;
    ...
    final Vector3f vector = new Vector3f(x, y,z);
     ...
     return branchgroup; 
       ...
       public BranchGroup getCubi3BranchGroup(BranchGroup branchGroup,int place,int id,float[][] colors) 
   { this.id=id;
     this.place=place;
    ...
    public Cubi3(BranchGroup brauchGroup,int nr,int place,int id,double paramDouble)
